...
include_once("../php/StoreManager.php");

$db = new dbManager($dbSerwer, $dbHost, $dbPass, $dbName);
$sm = new storeManager();

if (filter_input(INPUT_POST, "submit") == "removeFromStore") {
    $sm->removeFromStore($db);
}
?>
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item mx-0 mx-lg-1">
                        <a class="nav-link py-3 px-0 px-lg-3 active" href="Store.php">Własne</a>
                    </li>
                    <li class="nav-item mx-0 mx-lg-1">
    ...
    <section id="mainContent">
        <span class="main-content-text">Twoje wystawione produkty</span><br />
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo    "<tr>
                            ...
                            <td>$quantity</td>
                            <td>$date</td><td>";
                $sm->removeFromStoreForm($productId);
                echo    "</td></tr>";
            }

            echo '</tbody></table>';
        } else {
            echo "<p class='empty-store-info'>Brak wystawionych produktów.</p>";
        }
        echo "<p class='removed-from-store'></p>";

        if (isset($_SESSION["removed-from-store"])) {
            echo "<script>removedFromStore();</script>";
            unset($_SESSION["removed-from-store"]);
        }
        ?>
    </section>
